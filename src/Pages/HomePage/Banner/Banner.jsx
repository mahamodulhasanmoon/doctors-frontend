...
const Banner = () => {
 ...
 <div className="pt-[5rem] col-span-9 flex flex-col justify-start items-center">
    ...
    <div className="flex justify-start self-start  text-left flex-col lg:flex-row items-start gap-6 mt-6 lg:mt-4">
  <Link
    to="/book"
    className="w-full lg:w-auto h-14 px-6 bg-cyan-700 rounded-lg flex justify-center items-center gap-2.5 text-white text-sm lg:text-lg font-normal "
  >
    Book Appointment
  </Link>
  <Link
    to="/contact"
    className="w-full lg:mb-0   mb-6 lg:w-auto h-14 px-6 lg:px-[20px] rounded-lg border border-cyan-700 flex justify-center items-center gap-2.5 text-cyan-700 text-sm lg:text-lg font-normal mt-4 lg:mt-0"
  >
    Contact Us
  </Link>
</div>
  ...
  <div className="col-span-1 lg:mt-12  md:col-span-3 flex justify-center items-center">
    <div className="  bg-cyan-700 shadow-lg p-6 rounded-lg text-center">
      <div>
