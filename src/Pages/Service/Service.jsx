...
const Service = () => {
  return (
    <div className="mx-auto container">
      ...
      <section className="my-1">
        <div >
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 my-10">
  ...
  <div className="border-solid border-[#010202] border-8 top-0 left-0 w-[24rem] h-[28rem] pointer-events-none"></div>
