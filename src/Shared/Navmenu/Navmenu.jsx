...
const Navmenu = () => {
  ...
  return (
    <>
      <div className="lg:mx-auto max-w-screen-2xl bg-cyan-700 h-20 px-5 lg:px-36 py-12 border-b border-zinc-300 flex justify-between items-center">
        ...
        <div className="w-full hidden lg:flex lg:w-auto mt-4 lg:mt-0 px-4 py-2 rounded-lg text-center">
          <p className="flex items-center text-white lg:text-4xl  font-bold font-['Open Sans'] capitalize leading-[2.7rem]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="39"
              height="39"
